...
export const artifactSchema = z.object({
  ...
  content: z.string().describe('The main text content of the document.'),
  title: z.string().describe('Short title of the document. Max 50 characters.'),
  description: z.string().describe('Short description of the document. Max 100 characters.'),
